...
CMF_CONFIG_FILE := ${CURRENT_HDR_DIR}/cmfbuild.h
...
export CC_DEVICE
export DEVICE_FLAGS
export DEVICE_DLINK_FLAGS
export CURRENT_BASEIDIR
export DIM
export COMPILE_TIME_OPT
export CMF_PARALLEL=${PARALLEL}

.PHONY: final docs

final: ${DO_CLEAN} setup configFile ${TARGETNAME_CUDA} ${TARGETNAME_HYBRID_D} ${LINK_STEP} ${TARGETNAME_HYBRID_H} ${TARGETNAME_HOST}
...
configFile:
	@echo "#ifndef cmfbuild_AUTOGENERATED_H" > ${CMF_CONFIG_FILE}
	@echo "#define cmfbuild_AUTOGENERATED_H" >> ${CMF_CONFIG_FILE}
	@echo "#define CMF_PARALLEL ${PARALLEL}" >> ${CMF_CONFIG_FILE}
	@echo "#define CMF_ZLIB_EXT_ENABLE ${ZLIB_ENABLE}" >> ${CMF_CONFIG_FILE}
	@echo "#define CUDA_ENABLE ${CUDA_ENABLE}" >> ${CMF_CONFIG_FILE}
	@echo "#define CMF_DIM ${DIM}" >> ${CMF_CONFIG_FILE}
	@echo "#endif" >> ${CMF_CONFIG_FILE}
