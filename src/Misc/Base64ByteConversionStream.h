#ifndef CMF_BASE_64_BYTE_CONVERSION_STREAM_H
#define CMF_BASE_64_BYTE_CONVERSION_STREAM_H
#include <iostream>
namespace cmf
{
    //https://mathema.tician.de/what-they-dont-tell-you-about-vtk-xml-binary-formats/
    ///@brief Streams a byte array, but converts to base-64 represenation
    ///@param strm The output stream
    ///@param bytes A byte array to stream
    ///@param size The number of bytes to stream
    ///@author WVN
