...
int main(int argc, char** argv)
{
    ...
    userInput["allNeighs"].MapTo(&allNeighs) = new PTL::PTLBoolean(false, "dummy");
    userInput["level0"].MapTo(&level0) = new PTL::PTLBoolean(false, "dummy");
    userInput["doRefinement"].MapTo(&doRefinement) = new PTL::PTLBoolean(false, "dummy");
    userInput["testDir"].MapTo(&testDir) = new PTL::PTLEnum("x", "x:y:z", "dummy");
    userInput["testVal"].MapTo(&testVal) = new PTL::PTLInteger(-1, "dummy");
    testDir = 0;
    testVal = 0;
    //userInput["outputName"].MapTo(&outputName) = new PTL::PTLString("output/neigh.vtk", "dummy");
